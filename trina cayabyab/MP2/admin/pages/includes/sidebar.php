      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="#" class="nav-link active" id="side-dashboard">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link" id="side-customer">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../pre_register" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pre-register</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../paid_dp" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Paid Downn Payments</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../fully_paid" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Fully Paid</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="../list_item" class="nav-link" id="side-products">
          ...
          <li class="nav-item">
            <a href="../admin_list" class="nav-link" id="side-admin">
